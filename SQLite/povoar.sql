...
INSERT INTO Conteudo (idConteudo, nome, classificacao, faixaEtariaMinima, descricao) VALUES (11, 'Mamma Mia! Here We Go Again', 3.3, 'ALL', 'Sophie abre as portas do novo Hotel Bella Donna, lançando um olhar nostálgico sobre a vida da sua rebelde mãe e dando um passinho de dança (ou dois) em direção ao futuro.');
...
INSERT INTO Conteudo (idConteudo, nome, classificacao, faixaEtariaMinima, descricao) VALUES (15, 'Grinch', 3.1, 'ALL', 'O Grinch decide roubar o Natal de Whoville, mas um gesto de bondade da pequena Cindy Lou Who e da família dela pode ser suficiente para lhe derreter o coração.');
