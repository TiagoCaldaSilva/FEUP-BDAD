...
CREATE TABLE PagamentoCliente (
    idCliente              INTEGER  CONSTRAINT idCliente_notNull    NOT NULL,
    idPagamento            INTEGER  CONSTRAINT idPagamento_notNull  NOT NULL,  

    CONSTRAINT pagcliente_pk        PRIMARY KEY (idPagamento),
    CONSTRAINT pagcliente_fkc       FOREIGN KEY (idCliente)         REFERENCES Cliente(idCliente)       ON UPDATE CASCADE  ON DELETE RESTRICT,
...
CREATE TABLE Perfil (
    ...
    faixaEtaria            INTEGER  CONSTRAINT faixaEtaria_notNull  NOT NULL
                                    CONSTRAINT faixaEtaria_DV       DEFAULT 18
                                    CONSTRAINT faixaEtaria_valid    CHECK (faixaEtaria = 0      or
                                                                            faixaEtaria = 7     or
                                                                            faixaEtaria = 13    or
                                                                            faixaEtaria = 16    or
                                                                            faixaEtaria = 18),
...
CREATE TABLE Conteudo (
    ...
    faixaEtariaMinima      INETGER  CONSTRAINT faixaMin_notNull         NOT NULL
                                    CONSTRAINT faixaMin_DV              DEFAULT 18
                                    CONSTRAINT faixaMin_valid           CHECK (faixaEtariaMinima = 0 or
